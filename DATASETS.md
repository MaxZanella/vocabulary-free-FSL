...
### Flowers102
- Create a folder named `Flower102/` under `$DATA`.
...
### Food101
- Download the dataset from https://data.vision.ee.ethz.ch/cvl/datasets_extra/food-101/ and extract the file `food-101.tar.gz` under `$DATA`, resulting in a folder named `$DATA/Food101/`.
